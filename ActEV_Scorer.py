...
def score_basic(protocol_class, args):
    ...
    results = protocol.compute_results(alignment, args.uniq_conf)
...
if __name__ == '__main__':
    ...
    base_args = [[["-s", "--system-output-file"], dict(help="System output JSON file", type=str, required=True)],
                 ...
                 [["-u", "--uniq-conf"], dict(help="Number of Unique confidence scores to use", type=int, default=0, required=False)],
