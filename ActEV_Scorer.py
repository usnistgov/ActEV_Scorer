...
def score_actev19_ad_v3(args):
    from actev19_ad_v3 import ActEV19_AD_V3
    
    score_basic(ActEV19_AD_V3, args)
...
if __name__ == '__main__':
    ...
    add_protocol_subparser("ActEV19_AD_V3",
                           dict(help="Scoring protocol for the ActEV19 V3 Activity Detection task"),
                           score_actev19_ad_v3,
                           base_args)
