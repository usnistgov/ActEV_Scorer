...
class ActEV_SDL_V2(Default):
    ...
    def __init__(self, scoring_parameters, file_index, activity_index, command):
        ...
        self.file_framerates = {k: file_index[k]["framerate"] for k, v in file_index.items()}
    ...
    def default_kernel_builder(self, refs, syss):
        kernel = build_linear_combination_kernel([ build_temporal_second_overlap_filter_v2(self.file_framerates, self.scoring_parameters["activity.temporal_overlap_delta"]) ],
